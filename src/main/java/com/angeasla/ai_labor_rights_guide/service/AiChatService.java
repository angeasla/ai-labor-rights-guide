...
public class AiChatService {
    ...
    public String generateResponse(ChatRequestDto request) {
        ...
        String latestUserMessage = messages.get(messages.size() - 1).getContent();
        ...
        String dynamicSystemPrompt = """
            ...
            1. ΑΠΑΓΟΡΕΥΕΤΑΙ ΑΥΣΤΗΡΑ να χρησιμοποιείς εκφράσεις όπως 'βάσει του context', 'τα δεδομένα που έχω', 'το πλαίσιο που μου παρείχες', 'το αρχείο δεν περιέχει' ή οτιδήποτε παρόμοιο. 
            ...
            3. Κάνε πάντα μαθηματικούς/λογικούς ελέγχους και στο τέλος πρότεινε πρακτικά βήματα (π.χ. Επικοινωνία με Επιθεώρηση Εργασίας / Σωματείο).
            
            ΠΛΗΡΟΦΟΡΙΕΣ ΕΡΓΑΣΙΑΚΟΥ ΟΔΗΓΟΥ:
            ---------------------
            {CONTEXT_PLACEHOLDER}
            ---------------------
            ΟΔΗΓΙΑ: Απάντησε στην ερώτηση συνδυάζοντας τις παραπάνω πληροφορίες με τη νομοθεσία. Αν είναι άσχετες, αγνόησέ τες σιωπηλά χωρίς να το σχολιάσεις.
